...
DateTopicNotes2026-07-01Pandas basicsDataFrames, .loc vs .iloc, boolean filtering, dropna, drop_duplicates, CSV I/O — see pandas/pandas_notebook_learning_guide.md2026-07-02Pandas — e-commerce data cleaning & analysisgroupby().transform() for group-wise fillna, datetime extraction, revenue aggregation, pivot_table with margins=True — see pandas/electronics.ipynb2026-07-02Pandas — hospital records: cleaning, binning, pivotingMode/median/group-mean imputation, .dt accessor gotchas, pd.cut() bin-edge behavior, pivot table cross-tabs — see pandas/hos.ipynb and pandas/hos_notebook_description.md
